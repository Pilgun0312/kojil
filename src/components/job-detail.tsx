...
import { JOB_TYPES, JOB_MODES, EXPERIENCE_LEVELS, formatSalary, APPLICATION_STATUS } from "@/lib/constants";
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription className="flex items-center gap-2 pt-1">
                <Building2 className="h-4 w-4" /> {job.company.name} • <MapPin className="h-4 w-4" /> {job.location}
              </DialogDescription>
            </DialogHeader>
